    ...
    alter table if exists carrello 
       drop constraint if exists FK3sg1pyuurftxbo5oxnhar4mej;

    alter table if exists carrello 
       drop constraint if exists FK776wjw2xhhhnvng0dcvarv4tg;

    alter table if exists formato_libri 
       drop constraint if exists FK897x06dx0i8gc5sox9ibk3uqm;
    ...
    alter table if exists ordine_items 
       drop constraint if exists FKofvseou1lfqwyjlsdf6e5rfkt;
    ...
    alter table if exists wishlist 
       drop constraint if exists FKgjfhxgqp99y1fi1jka43fadm9;
    ...
    drop table if exists formato_libri cascade;
    ...
    alter table if exists carrello 
       drop constraint if exists FKo3k7lnefiyeqjhopvy6y1b1x9;
