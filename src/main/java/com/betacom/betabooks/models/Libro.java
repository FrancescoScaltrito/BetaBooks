...
public class Libro {
   ...
   // @Lob
    ...
    //Lombok non fa il getter in automatico boh
	...
	@ManyToMany
	@JoinTable(name = "libri_categorie", joinColumns = @JoinColumn(name = "id_libro"), inverseJoinColumns = @JoinColumn(name = "id_categoria"))
